...
export const PRICING_PLANS = [
  {
    ...
    features: [
      ...
      "Gestor de menú digital",
      "QR Menú",
      "Carta QR para mesas",
      "Hasta 10 mesas configurables",
      "Panel básico de administración",
      "Configuración general del restaurante",
      "Estados de pedidos",
      "Interfaz responsive para celular/tablet",
  ...
  },
  {
    ...
    features: [
      ...
      "Panel optimizado para cocina",
      "Soporte prioritario",
      "Backups automáticos básicos",
    ],
    highlighted: true,
    cta: "Solicitar demo",
  },
  {
    ...
    features: [
      ...
      "Dashboard global centralizado",
      "Control individual por sucursal",
      ...
      "Monitoreo avanzado",
      "SLA empresarial",
      "Posibilidad de módulos exclusivos",
